  ...
  return (
    <Box
      sx={{
        display: "flex",
        minHeight: "100vh",
      bgcolor: isDark ? "#0D0D14" : "background.default",
      backgroundImage: isDark
        ? `
          radial-gradient(at 0% 0%, rgba(113, 90, 248, 0.08) 0px, transparent 50%),
          radial-gradient(at 100% 0%, rgba(113, 90, 248, 0.06) 0px, transparent 50%),
          radial-gradient(at 100% 100%, rgba(113, 90, 248, 0.04) 0px, transparent 50%),
          radial-gradient(at 0% 100%, rgba(113, 90, 248, 0.03) 0px, transparent 50%)
        `
        : "none",
        position: "relative",
      }}
